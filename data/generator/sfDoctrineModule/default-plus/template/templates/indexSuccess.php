<h1><?php echo sfInflector::humanize($this->getPluralName()) ?> 一覧</h1>
...
<?php if (isset($this->params['route_prefix']) && $this->params['route_prefix']): ?>
  <a href="[?php echo url_for('<?php echo $this->getUrlForAction('new') ?>') ?]">追加</a>
<?php else: ?>
  <a href="[?php echo url_for('<?php echo $this->getModuleName() ?>/new') ?]">追加</a>
<?php endif; ?>
