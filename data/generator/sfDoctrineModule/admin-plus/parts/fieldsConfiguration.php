...
<?php unset($this->config['new']['title']) ?>
  ...
  {
    return '<?php echo $this->escapeString(isset($this->config['confirm']['title']) ? $this->config['confirm']['title'] : 'New '.sfInflector::humanize($this->getModuleName())) ?>';
<?php unset($this->config['confirm']['title']) ?>
  }
...
<?php unset($this->config['new']['display']) ?>
  ...
  {
    return <?php echo $this->asPhp(isset($this->config['confirm']['display']) ? $this->config['confirm']['display'] : array()) ?>;
<?php unset($this->config['confirm']['display']) ?>
  }
...
<?php foreach (array('list', 'filter', 'form', 'edit', 'new', 'confirm') as $context): ?>
